...
{
  "$end", "error", "$undefined", "DIGIT", "ID", "EVALCFG", "PATH",
  "EVALUATOR", "OPENPAR", "CLOSEPAR", "\"\\n\"", "$accept", "ArchCfg",
  "Evaluator", 0
};
#endif
...
{
      -3,     1,     1,     5,     7,     9,     6,     2,     2,    10,
      11,     8,     0,     0,     0,    12
};

static const yytype_int8 yycheck[] =
{
       0,     1,     1,    10,     0,     8,     4,     7,     7,     6,
       5,     4,    -1,    -1,    -1,     9
};
...
#line 46 "sintactico.y"
    {(yyval.cadena)= (yyvsp[(2) - (6)].cadena), (yyvsp[(4) - (6)].cadena), (yyvsp[(5) - (6)].cadena);;}
    break;
